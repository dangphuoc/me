...
export default function StoryPostClient({ post, locale, author = 'Phuoc Nguyen' }: StoryPostClientProps) {
    ...
    <div className="min-h-screen py-16 px-4 sm:px-6 lg:px-8">
      <article className="max-w-4xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mb-6">
          <Link href={`/${locale}/stories`} className="text-xs text-th-dim hover:text-th-accent transition-colors">
            <ArrowLeft size={14} className="inline mr-1" />cd ../stories
          </Link>
        </motion.div>

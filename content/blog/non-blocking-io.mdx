...
title_vi: Non-Blocking I/O - Nghệ thuật không chờ đợi
title_en: Non-Blocking I/O - The Art of Not Waiting
excerpt_vi: Hiểu sâu về Event Loop và Non-Blocking I/O thông qua câu chuyện quán coffee. Từ Blocking đến Async, từ Concurrency đến Parallelism.
excerpt_en: Deep dive into Event Loop and Non-Blocking I/O through a coffee shop story. From Blocking to Async, from Concurrency to Parallelism.
date: 2024-01-25
tags:
  - Non-Blocking
  - Event Loop

---
title: "Ranh Giới Mong Manh: AI Agent hay Cron Job?"
...
# Ranh Giới Mong Manh: AI Agent hay Cron Job?

## Câu chuyện bắt đầu từ một buổi review

Tuần trước, trong buổi review thiết kế, một bạn developer trình bày giải pháp cho một task tưởng chừng đơn giản: **tổng hợp báo cáo doanh thu hàng ngày từ nhiều nguồn, rồi gửi email cho sếp.**

Bạn ấy đề xuất dùng AI Agent.

"Agent sẽ đọc data từ các nguồn, tự quyết định cách tổng hợp, rồi sinh ra email với insights thông minh."

Nghe rất hay. Rất "2026". Nhưng radar "over-engineering" trong đầu tôi bắt đầu kêu bíp bíp.

Tôi hỏi: "Data format có thay đổi không?"

"Không, luôn là CSV cùng schema."

"Cách tổng hợp có thay đổi không? Ví dụ tuần này tính theo region, tuần sau tính theo product?"

"Không, luôn là sum theo ngày, group theo category."
...
Một cái cron job chạy SQL tổng hợp báo cáo mỗi sáng, với schema cố định, logic cố định, output cố định — **không có lý do gì phải gọi LLM cả.** Chi phí cao hơn. Latency cao hơn. Output không deterministic. Và debug thì... chúc may mắn.
...
Ví dụ: mỗi ngày số lượng đơn hàng khác nhau. Hôm nay 1,000 đơn, ngày mai 50,000 đơn. Dữ liệu "biến động." Nhưng cách tổng hợp báo cáo thì vẫn y nguyên: sum revenue, group by category, calculate growth rate.

Nhiều người thấy dữ liệu "phức tạp" thì nghĩ cần AI. **Nhưng phức tạp không đồng nghĩa với mơ hồ.** Dù data có 100 triệu rows, nếu cách xử lý là deterministic, thì job truyền thống là đủ.

---
title: API Contract - Khi code biết nói chuyện
excerpt: Câu chuyện về những API "câm lặng" và hành trình tìm lại tiếng nói thông qua OpenAPI. Contract-First Development với Vert.x và nghệ thuật viết API biết tự giải thích.
date: 2024-01-15
tags:
  - OpenAPI
  - Vert.x

...
> *"🔔 Ticket ABC-123 is Ready for QC. Assignee: @An. [Jira Link]*"

Minh doesn't need to type anything. System does it.

**Timer + Reminder:**

If ticket is in "Ready for PO Review" for over 24 hours with no action from Linh, bot auto-sends reminder:

> *"⏰ Ticket ABC-123 waiting for PO review over 24h. @Linh*"
...
AI can help here. An just describes briefly or sends screenshot, AI generates fully formatted bug report:
...
An reviews 30 seconds, submits. Minh reads and knows exactly what to do.
